...
public class 대패삼겹살간장볶음 {
	...
	public static void print(String x) {
		System.out.println(Integer.parseInt(x)+"인분 제작에 필요한 재료\r");
		...
		System.out.println();
		System.out.println("조리순서 \r\r "
				+ "1. 준비된 분량의 간장, 설탕, 다진마늘, 맛술, 참치액, 후추를 넣고 간장소스를 만들어줍니다. \r "
				+ "2. 팬에 대패삼겹살을 넣고 익기전에 펴면서 구워줍니다.(익으면 뭉쳐진 채로 펴지지 않아요~!) \r "
				+ "3. 흘러 나온 기름은 키친타올로 닦아주세요. \r "
				+ "4. 대패 삼겹살을 한 쪽으로 밀어놓고 간장소스를 팬에 부어 살짝 졸여주세요. \r "
				+ "5. 간장소스가 고루 섞이도록 앞뒤로 뒤적이면서 노릇노릇 바삭하게 구워주세요. \r "
